...
Enhances the WordPress admin plugin installer with advanced filtering, sorting, and rating capabilities. Features colored status indicators and modern UI improvements.

== Description ==

WordPress Plugin Directory Filters enhances the built-in WordPress plugin installer with powerful filtering and sorting capabilities while maintaining seamless integration with the existing interface.
...
1. Upload the plugin files to the `/wp-content/plugins/wp-plugin-directory-filters` directory, or install the plugin through the WordPress plugins screen directly.
...
= 1.0.0 =
Initial release of WordPress Plugin Directory Filters. Enhances your plugin installer with advanced filtering and visual quality indicators.
